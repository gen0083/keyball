...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    KC_TAB    , KC_A     , KC_S      , KC_D        , LT(2,KC_F),KC_G         ,         KC_H           , KC_J         , KC_K      , LT(5,KC_L)     , KC_LBRC      , KC_RBRC  ,
  ...
  [1] = LAYOUT(
    ...
    _______  , S(KC_6)   , S(KC_7)   , S(KC_8)     , S(KC_9)   , S(KC_0)     ,         KC_EQL         , S(KC_EQL)    , KC_BSLS   , KC_QUOT        , S(KC_QUOT)   , KC_INT3  ,
               _______   , _______   , _______     , _______   , _______     ,         SFT_T(KC_LNG1) , GUI_T(KC_LNG2)                            , S(KC_BSLS)
  ),

  [2] = LAYOUT(
    _______  , KC_PSLS   , KC_P7     , KC_P8       , KC_P9     , KC_PAST     ,         _______        , _______      , _______   , _______        , _______      , _______  ,
    _______  , KC_PCMM   , KC_P4     , KC_P5       , KC_P6     , KC_PMNS     ,         _______        , _______      , _______   , _______        , _______      , _______  ,
    _______  , KC_BSPC   , KC_P1     , KC_P2       , KC_P3     , KC_PPLS     ,         _______        , _______      , _______   , _______        , _______      , _______  ,
